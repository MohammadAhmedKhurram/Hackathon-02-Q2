...
export default function ContactUs() {
  return (
    <div>
      ...
      />
      <div className="overflow-hidden 2xl:ml-[375px]">
        <div className="flex mt-[120px] flex-wrap 2xl:justify-normal justify-center gap-28">
          <div>
        ...
        <div className="flex flex-wrap 2xl:justify-normal justify-center">
          ...
          <img
            src="/Group 124.png"
            alt="--"
            className="mt-[120px] mb-[239px] w-[300] h-[350px] lg:w-[723px] lg:h-[692px]"
          />
        </div>
      </div>
    </div>
