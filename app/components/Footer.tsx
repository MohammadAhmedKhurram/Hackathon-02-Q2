...
export default function Footer() {
  return (
    <div>
      <footer className="w-full lg:h-[478px] bg-[#EEEFFB] flex xl:justify-start gap-7 lg:gap[600px] xl:gap-[100px] xl:px-[310px] px-4 justify-center flex-wrap h-auto pb-[40px] lg:pb-0">
