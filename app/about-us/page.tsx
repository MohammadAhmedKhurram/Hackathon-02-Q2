    ...
    <div>
      ...
      <div className="flex gap-2 lg:gap-[30px] lg:mt-[122px] justify-center ">
        ...
        <div className="flex flex-col justify-center">
          <h3 className="text-2xl lg:text-[36px] font-bold text-[#151875] lg:w-[512px] m-0 lg:leading-[48px] text-left mb-[6px] lg:mb-[14px] mt-[38px]">
            Know About Our Ecomerce Business, History
          </h3>
          <p className="text-[14px] lg:text-base font-semibold lg:w-[580px] m-0 text-[#8A8FB9] mb-[35px] lg:mb-[83px]">
      ...
      <div className="mt-[141px]">
        ...
        <div className="flex justify-center flex-wrap gap-0 lg:gap-32 mt-[67px]">
          <ShopexCard
        ...
        <div className="w-[689px] h-[265px] mb-[382px] ">
          <div className="flex flex-col justify-center items-center">
            ...
            <img
              src="/Group 200.png"
              alt="--"
              className="text-center mt-16 items-center w-[191px] h-[64px]"
            />
            <h2 className="text-[22px] font-semibold text-[#151875] mt-[25px]">
              Selina Gomez
            </h2>
            <p className="text-[10px] font-semibold text-[#8A8FB9]">
              Ceo At Webecy Digital
            </p>
            <p className="mt-[14px] text-[#8A8FB9] text-[14px] lg:text-[16px] font-bold leading-[25.6px] text-center">
